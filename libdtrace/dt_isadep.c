...
#else
	if (DeviceIoControl(dtp->dt_ftfd, FASTTRAPIOC_MAKEPROBE, ftp, 0, ftp, 0, &sz, NULL) == 0) {
#endif
...
#else
		if (DeviceIoControl(dis->dtp->dt_ftfd, FASTTRAPIOC_GETINSTR, &instr, 0, &instr, 0, &sz, NULL) != 0)
#endif
